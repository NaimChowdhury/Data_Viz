...
age_child_mung <- rename(age_child_mung, Age = age, Children = childs)
...
ggplotly(age_child_plot) %>%
  ...
  add_annotations(text = paste0("Based on the 2016 GSS with 2849 respondents"), showarrow = FALSE, font = list(size = 16), x = 0.5, xref = "paper", xanchor = "center", y = 1.12, yref = "paper")
