...
```{r}
tv <- GSS_2016 %>% filter(TVHOURS != "NA", AGE != "NA", RACE != "NA", as.numeric(TVHOURS) > -1 && as.numeric(TVHOURS) < 98, as.numeric(AGE) < 98) %>%  select(ID,TVHOURS)  
#REMOVE NAs, filter out categorical values, convert to numeric type
age <- GSS_2016 %>% filter(TVHOURS != "NA", AGE != "NA",RACE != "NA", as.numeric(TVHOURS) > -1 && as.numeric(TVHOURS) < 98, as.numeric(AGE) < 98) %>% select(ID, AGE) 
race <- GSS_2016 %>% filter(TVHOURS != "NA", AGE != "NA",RACE != "NA", as.numeric(TVHOURS) > -1 && as.numeric(TVHOURS) < 98, as.numeric(AGE) < 98) %>% select(ID,RACE)
