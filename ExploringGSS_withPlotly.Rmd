...
```{r}
tv <- GSS %>% filter(TVHOURS != "NA", AGE != "NA", RACE != "NA", as.numeric(TVHOURS) > -1 && as.numeric(TVHOURS) < 98, as.numeric(AGE) < 98) %>%  select(ID,TVHOURS) #%>% unlist %>% as.numeric 
#REMOVE NAs, filter out categorical values, convert to numeric type
age <- GSS %>% filter(TVHOURS != "NA", AGE != "NA",RACE != "NA", as.numeric(TVHOURS) > -1 && as.numeric(TVHOURS) < 98, as.numeric(AGE) < 98) %>% select(ID, AGE) #%>% unlist %>% as.numeric
race <- GSS %>% filter(TVHOURS != "NA", AGE != "NA",RACE != "NA", as.numeric(TVHOURS) > -1 && as.numeric(TVHOURS) < 98, as.numeric(AGE) < 98) %>% select(ID,RACE)
