...
__Interpretation__: The odds of  a satellite nearby are predicted to increase 1.6 fold (With a 95% confidence interval of 1.33 to 2.00) for every 1kg increase in the width of a crab.
  ...
  __Interpretation__: For a fixed value of width, the odds of a satellite nearby are predicted to decrease 1.3 fold if the crab is dark. Under this model, the effect of color is the same at any given width. 
